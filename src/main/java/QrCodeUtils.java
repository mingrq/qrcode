...
public class QrCodeUtils {
     ...
     * @param Height     LOGO高度  -1默认60
     */
    public QrCodeUtils(int QrCodeSize, int Width, int Height) {
        if (QrCodeSize > 0)
     ...
     * @throws Exception
     */
    public String encodeBase64(String content, String imgPath, boolean needCompress) throws Exception {
        BufferedImage image = createImage(content, imgPath,
                needCompress);
     ...
     * @throws Exception
     */
    public String encodeBase64(String content, boolean needCompress) throws Exception {
        return encodeBase64(content, null, needCompress);
    }
     ...
     * @param Height     LOGO高度  -1默认60
     */
    public void setQrCodeSize(int QrCodeSize, int Width, int Height) {
        if (QrCodeSize > 0)
            QRCODE_SIZE = QrCodeSize;
        if (Width > 0)
            WIDTH = Width;
